...
static/
  ...
  syntax_highlighting.css - syntax coloring for expressions
  logo_animation.css      - background logo transitions
  js/
    main.js               - UI logic
    prefetch.js           - prefetches random chars for instant display
    visualize.js          - expression visualizer animation
    syntax_highlighting.js - syntax coloring logic
    logo_animation.js     - logo animation logic (tab pop, visualize combo)
  data/
